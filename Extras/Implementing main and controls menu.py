...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		if (20 - (pygame.time.get_ticks() - menu.play_button_clicked_time) / 1000) > 0:
			...
			# Draw the translucent countdown timer , edit the x co-ord
			draw_alpha_text(str(round(20 - (pygame.time.get_ticks() - menu.play_button_clicked_time) / 1000)), countdown_font, countdown_colour, (screen_width / 2) - 52, (screen_height / 2) - 450)
