...
class Player(pygame.sprite.Sprite):
	...
	def update_animation(self):
		...
		run_animation_frame_cooldown = 50
	...
	def update(self):
		...
		if key[pygame.K_d]:
			...
			self.action = 2
			dx += 14 * self.speed_multiplier
		# Check if none of these keys are being pressed
	...
	def draw(self):
		...
		screen.blit(self.image, (self.rect.x - 18, self.rect.y))
...
run = True
while run:
	print(spawn_powerups_in_menu_time)
	# Limit FPS to 60
	clock.tick(60)	
