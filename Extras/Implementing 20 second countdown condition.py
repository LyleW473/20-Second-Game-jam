...
game_over_surface.set_alpha(90)
...
while run:
	...
	if (20 - (pygame.time.get_ticks() - countdown_time) / 1000) > 0:
		#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		# WORLD TILES
		...
		draw_alpha_text(str(round(20 - (pygame.time.get_ticks() - countdown_time) / 1000)), countdown_font, countdown_colour, (screen_width / 2) - 52, (screen_height / 2) - 450)
