...
while run:	
	...
	if clicked == True:
		...
		if staff.position_finding == False:
			...
			#print("staff.rect.centerx = ", staff.rect.centerx,"staff.rect.centery = ", staff.rect.centery)
			#print("staff.rect.left = ", staff.rect.left, "staff.rect.right = ",	staff.rect.right)		
			#print(position)
			# Set position vector
