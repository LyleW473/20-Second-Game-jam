...
while run:
	...
	if pygame.time.get_ticks() - game_started_time_double_score > collectible_powerups_spawning_cooldown:
		...
		# Limit the number of double_score powerups to 2 
		if len(double_score_powerup_group) < 2:
			...
			#print("created at: ", possible_spawning_locations[random_index_list[random_index]][0], possible_spawning_locations[random_index_list[random_index]][1])
			#print("using index:", random_index_list[random_index])
	...
	#print(pygame.time.get_ticks() - game_started_time_double_score)
