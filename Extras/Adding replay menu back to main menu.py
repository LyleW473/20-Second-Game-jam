...
def reset_level(staff_count, allowed_to_click, amount_of_time, total_score, game_started_time_peach, game_started_time_collectible_powerups, num_of_collectible_powerups, random_index_list, starting_enemy_spawned):
	# Staff 
	...
	player.rect.centery = (screen_height - 80)
	...
	return staff_count, allowed_to_click, amount_of_time, total_score, game_started_time_peach, game_started_time_collectible_powerups, num_of_collectible_powerups, random_index_list, starting_enemy_spawned
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		# If the 20 second countdown has ended then do this:
			...
			if menu.reset_level == True:
				...
				staff_count, allowed_to_click, amount_of_time, total_score, game_started_time_peach, game_started_time_collectible_powerups, num_of_collectible_powerups, random_index_list, starting_enemy_spawned = reset_level(staff_count, allowed_to_click, amount_of_time, total_score, game_started_time_peach, game_started_time_collectible_powerups, num_of_collectible_powerups, random_index_list, starting_enemy_spawned)
